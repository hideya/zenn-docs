...
> [「【LangChain】の能力を 450+ の【MCP】ツール群で 一気に拡張する方法！🤩 ReAct Agent から使う！」](https://zenn.dev/h1deya/articles/langchain-mcp-tools)
...
いずれせよ、コミュニティでの盛り上がりが素晴らしいので、各社がどう出てくるのか。特に、OpenAI がどう動くのか？ そして「リモートMCP接続」が正式に発表された時、果たして Anthropic はどこかとのパートナーシップの類を発表するのか？（たぶんどこかのメジャーなサービスプロバイダと PoC してるだろうと憶測）、目が離せません！

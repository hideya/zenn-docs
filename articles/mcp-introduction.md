...
ご覧のように、すでに 1500 以上もの MCPサーバが利用できるんです！
...
だって 1500+もの機能がそろった MCPサーバを活用したアプリを、できるだけ楽に作りたいじゃないですか。で、LLM アプリの作成といえば [LangChain](https://www.langchain.com/)。LangChain のツール呼び出しで MCPサーバが簡単に呼び出せれば、これはうれしいはずだ！ ということで、早速作って以下で公開しました：

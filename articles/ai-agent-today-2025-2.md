...
なお、**猛烈に未来を感じさせるという点で特にオススメなのは、Anthropic のパソコン操作自動化のデモ「Computer Use」** です。まだご覧になったことがない方は、**ぜひチェック**してみてください！
...
![anthropic-computer-use-1](/images/ai-agent-today-2025-2/anthropic-computer-use-1.png =500x)
...
![anthropic-computer-use-2](/images/ai-agent-today-2025-2/anthropic-computer-use-2.png =500x)
1. 「CNNが見たい」
   - 「はい、CNNのウェブサイトを開きましょう。アドレスバーをクリックしてCNNのURLを入力します。」
   - 「CNNのウェブサイトが表示されました。現在のトップニュースやその他の最新ニュースを見ることができます。…」
![anthropic-computer-use-3](/images/ai-agent-today-2025-2/anthropic-computer-use-3.png =500x)
1. 「日本のニュースを表示して」
   - 「はい、CNNの日本関連のニュースを探してみましょう。スクリーンショットでは、トップニュースの中に"Japan sinkhole"（日本の陥没）というニュースが見えます。まずはヘッドラインの一つにある「Japan」をクリックして、日本関連のニュースを表示させましょう。」
   - 「検索機能を使って日本のニュースを探すのが最も効率的かもしれません。画面右上の検索アイコンをクリックします：」
...
![anthropic-computer-use-4](/images/ai-agent-today-2025-2/anthropic-computer-use-4.png =500x)

本当に簡単なデモでしたが、**僕的な圧巻は、「日本に関するニュースを表示して」との雑な指示から、それを実現するための具体的な操作ステップを見出して、それを順に実施し、もしうまく行かなければ、代替手段を考えて、それを実行する**という…

**ほぼ、人間相手に指示出してるの感覚**です… 😳

このデモでは、コンピュータ環境は、限定されたアプリがインストールされた Linux でしたが、**もし、業務用 PC でこれを動かせたら**（もちろんセキュリティとか色々課題はありますが）…
妄想が膨らみます…

> ちなみにこのデモは画像を多く扱うため、遊んでいるとすぐに「Rate Limit」に引っかかってしまいます… 

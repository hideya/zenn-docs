---
title: "AI エージェントによる Skill 利用を把握する ─ SkillTrace で「どの Skill が なぜ 使われたのか」を追跡！"
emoji: "🛠️"
...
*実際の SkillTrace 利用の様子*](https://github.com/user-attachments/assets/f903560b-ac99-4ed8-b1be-4cf99482a291)
...
以下のような main page が見えると思います。もしまだ１つしか run していない場合は、項目が１つだけ表示されます。

ここでは、trace runs、status、trace mode、result、model/client context、mode comparison などが表示されます。
...
Target repo が Git worktree 内にある場合、SkillTrace は run start 時点で skill files の軽量な snapshot を記録します。

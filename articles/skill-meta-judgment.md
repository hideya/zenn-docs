...
AIエージェントが実世界の複雑な作業で弱さを見せる理由のひとつは、単にSkillの不足や推論能力の限界だけではなく、人間の経験を整理されたSkillへ変換する過程で、何か重要なものが失われているからではないか。

むしろ、Skillを詳細に、明確に、綺麗に書けば書くほど、失われてしまうものがあるのではないか？ そんな風に考え始めました。
...
ここで、Unresolved Experience とは、**まだ安定した一般則へ還元できないが、将来の Meta-Judgment に価値を持つ Episode** のことです。
